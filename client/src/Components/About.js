...
export default function About() {
  return (
    ...
    <div>This app allows you to search for hiking trails near you by searching your city and state.
      The data includes the name, a brief description, the length and the location.
